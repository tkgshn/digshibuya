...
var users_interface_1 = require("./users.interface");
var swagger_1 = require("@nestjs/swagger");
var UsersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('User'), (0, common_1.Controller)('users'), (0, common_1.UseInterceptors)(common_1.ClassSerializerInterceptor)];
        ...
        UsersController_1.prototype.getProfile = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = users_interface_1.UserProfile.bind;
                            return [4 /*yield*/, this.usersService.retrieveUserProfile(req.user.id)];
                        case 1: return [2 /*return*/, new (_a.apply(users_interface_1.UserProfile, [void 0, _b.sent()]))()];
                    }
                });
            });
        };
        UsersController_1.prototype.updateProfile = function (req, body) {
            return __awaiter(this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = users_interface_1.UserProfile.bind;
                            return [4 /*yield*/, this.usersService.updateUserProfile(req.user.id, body)];
                        case 1: 
                        // Since we already have the user ID, we do not need any params
                        return [2 /*return*/, new (_a.apply(users_interface_1.UserProfile, [void 0, _b.sent()]))()];
                    }
                });
            });
        };
        UsersController_1.prototype.getProfileById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = users_interface_1.UserProfile.bind;
                            return [4 /*yield*/, this.usersService.retrieveUserProfile(id)];
                        case 1: return [2 /*return*/, new (_a.apply(users_interface_1.UserProfile, [void 0, _b.sent()]))()];
                    }
                });
            });
    ...
    (function () {
        ...
        _getProfile_decorators = [(0, swagger_1.ApiOperation)({
                description: 'Retrieves the user profile based on the user session cookies',
            }), (0, swagger_1.ApiOkResponse)({
                description: 'The user profile',
                type: users_interface_1.UserProfile,
            }), (0, common_1.UseGuards)(nextauth_guard_1.NextAuthGuard), (0, common_1.Get)('profile')];
        _updateProfile_decorators = [(0, swagger_1.ApiOperation)({
                description: 'Updates the user profile',
            }), (0, swagger_1.ApiOkResponse)({
                description: 'Updated user profile',
                type: users_interface_1.UserProfile,
            }), (0, common_1.UseGuards)(nextauth_guard_1.NextAuthGuard), (0, common_1.Patch)('profile')];
        _getProfileById_decorators = [(0, swagger_1.ApiOperation)({
