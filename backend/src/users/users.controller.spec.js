...
describe('UsersController', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        var module, contributions, grants, context;
                ...
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        ...
                        providers: [
                            ...
                            },
                            {
                                ...
                                useValue: fixtures_1.usersService,
                            },
                        ],
                    }).compile()];
                case 1:
                    ...
                    contributions = user.contributions, grants = user.grants, context = __rest(user, ["contributions", "grants"]);
                    userContext = context;
                    return [2 /*return*/];
            }
        });
    ...
    describe('retrieveUserProfile', function () {
        it('should call the service function appropriately', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, controller.getProfile({
                            user: userContext,
                        })];
                    case 1:
                        _a.sent();
    ...
    describe('updateProfile', function () {
        ...
        it('should call the service function appropriately', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, controller.updateProfile({
                            user: userContext,
                        }, data)];
                    case 1:
                        _a.sent();
                        expect(service.updateUserProfile).toHaveBeenCalledWith(userContext.id, data);
                        return [2 /*return*/];
                }
            });
        }); });
