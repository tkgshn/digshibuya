...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
         ...
         * @returns
         */
        AuthService_1.prototype.grantAdminPrivilege = function (email, user) {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (user.role !== client_1.Role.Admin)
                                throw new common_1.HttpException('Not enough permissions', common_1.HttpStatus.FORBIDDEN);
         ...
         * @returns
         */
        AuthService_1.prototype.revokeAdminPrivilege = function (email, user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
