...
describe('AuthController', function () {
                ...
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        ...
                        providers: [
                            ...
                            },
                            {
                                ...
                                useValue: fixtures_1.authService,
                            },
                        ],
    ...
    describe('grantAdminPrivilege', function () {
        it('should call the service function appropriately', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, controller.grantAdminPrivilege({
                            email: user.email,
                        }, {
                            user: user,
                        })];
                    case 1:
                        _a.sent();
                        expect(service.grantAdminPrivilege).toHaveBeenCalledWith(user.email, user);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('revokeAdminPrivilege', function () {
        it('should call the service function appropriately', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, controller.revokeAdminPrivilege({
                            email: user.email,
                        }, {
                            user: user,
                        })];
                    case 1:
                        _a.sent();
                        expect(service.revokeAdminPrivilege).toHaveBeenCalledWith(user.email, user);
                        return [2 /*return*/];
                }
            });
        }); });
