...
var invites_controller_1 = require("./invites.controller");
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        ...
                        providers: [
                            ...
                            {
                                provide: invites_service_1.InvitesService,
                                useValue: fixtures_1.invitesService,
                            },
                        ],
                ...
                case 1:
                    module = _a.sent();
                    controller = module.get(invites_controller_1.InvitesController);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, controller.claimInviteCode(code, {
                                user: user,
                            })];
                    case 1:
                        _a.sent();
